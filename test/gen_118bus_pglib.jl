...
options[:remove_Bshunt]  = false # NOTE! SWITCHED
options[:remove_tap]     = true # NOTE! SWITCHED
...
opf2pd("/Users/jakeroth/git/PowerDynamics.jl/examples/pglib_118bus/grid118_new_$(options[:remove_Bshunt])_$(options[:remove_tap]).json", solution, opfmodeldata, line_type, phys)
